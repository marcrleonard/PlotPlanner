...
sys.path.append('/Users/marcleonard/projects/inkscape_stuff')

sys.path.append('/Users/marcleonard/projects/plotplanner/python/pyaxidraw')
...
try:
    range = range  # We have Python 2
except NameError:
    range = range  # We have Python 3
try:
        ...
        for node in a_node_list:
            ...
            if node.tag == inkex.addNS('g', 'svg') or node.tag == 'g':
                ...
                if node.tag == inkex.addNS('path', 'svg'):
                    ...
                    continue
                elif not isinstance(node.tag, string):
...
if __name__ == '__main__':
    ...
    try:
        ad.connect()
        # ad.update_options()
        ad.plot_setup('/Users/marcleonard/Projects/plotplanner/python/tree.svg')        # Load file & configure plot context
