...
from math import *
# local library
from plotcontrol import inkex
from plotcontrol import simplestyle
...
def draw_SVG_dot(c, st, name, parent):
...
def draw_SVG_line( one, two, st, name, parent):
...
def get_darkened_colour( color, factor):
    r,g,b = color
