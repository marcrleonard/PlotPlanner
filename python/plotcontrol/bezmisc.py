...
def bezierparameterize(b):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = b
    #parametric bezier
    x0=bx0
    y0=by0
    cx=3*(bx1-x0)
...
def linebezierintersect(l):
    ((lx1, ly1), (lx2, ly2)), ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = l
    #parametric line
    dd=lx1
    cc=lx2-lx1
    bb=ly1
...
def beziertatslope(d):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)), (dy, dx) = d
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
...
def bezierlengthSimpson(b, tolerance = 0.001):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = b
...
def beziertatlength(b, l = 0.5, tolerance = 0.001):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = b
    global balfax,balfbx,balfcx,balfay,balfby,balfcy
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
    balfax,balfbx,balfcx,balfay,balfby,balfcy = 3*ax,2*bx,cx,3*ay,2*by,cy
