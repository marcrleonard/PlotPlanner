...
from python.plotcontrol.hershey import hersheydata        #data file w/ Hershey font data
...
if __name__ == '__main__':
	...
	aa = ['hershey.py', '--tab="splash"', '--text=Blah!', '--action=render', '--fontface=futuram', '/Users/marcleonard/Projects/plotplanner/python/tree_test_text.svg']
	e = Hershey()
