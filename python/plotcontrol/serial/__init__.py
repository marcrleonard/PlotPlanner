...
from python.plotcontrol.serial.serialutil import *
...
if sys.platform == 'cli':
    from python.plotcontrol.serial.serialcli import Serial
else:
    import os
    # chose an implementation, depending on os
    if os.name == 'nt':  # sys.platform == 'win32':
        from python.plotcontrol.serial.serialwin32 import Serial
    elif os.name == 'posix':
        from python.plotcontrol.serial.serialposix import Serial, PosixPollSerial, VTIMESerial  # noqa
    elif os.name == 'java':
        from python.plotcontrol.serial.serialjava import Serial
    else:
