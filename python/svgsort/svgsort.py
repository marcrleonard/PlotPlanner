...
class Svgsort():
  ...
  def load(self, fn):
    ...
    # fn is now the SVG string....

    paths, _, svg_atr = svg2paths(fn,
  ...
  def save(self, fn, paper, pad=None, padAbs=False, preserve_orientation=False, original_is_portrait=False):
    ls = get_long_short(self.paths, pad, padAbs, preserve_orientation, original_is_portrait)
